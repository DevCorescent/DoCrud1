 ...
 * by side, then the full-width profile-score card with its ring, headline,
 * "3x more visibility" line, Edit Profile button and Improve score link. It was
 * once compacted into a single strip and that is not this design — restore the
 * reference, not the strip.
 *
