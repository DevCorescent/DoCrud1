  ...
  try {
    ...
    return NextResponse.json({
      service: {
        ...
        useMainProfileImage: !!service.useMainProfileImage,
        location: service.location || null,
        workMode: service.workMode || null,
        availability: service.availability || null,
        gallery: service.gallery?.length ? service.gallery : null,
        skills: service.skills?.length ? service.skills : null,
        deliverables: service.deliverables?.length ? service.deliverables : null,
        requirements: service.requirements || null,
        process: service.process || null,
        languages: service.languages?.length ? service.languages : null,
